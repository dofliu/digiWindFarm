...
- wake-added turbulence intensity implemented (Crespo-Hernández 1996 / IEC 61400-1 Annex E; per source-target pair `TI_added=0.73·a^0.8325·TI_amb^0.0325·(x/D)^-0.32`, multi-wake sum-of-squares superposition; combined in quadrature with localized-pocket TI multiplier and fed into per-turbine AR(1) wind generator so downstream wind σ rises naturally; new `WMET_WakeTi` SCADA tag, %, 0–40) — see #103
